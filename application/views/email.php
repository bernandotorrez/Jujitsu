            ...
            <tr>
              <td valign="top" class="em_aside">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td align="center" style="font-family:Open Sans, Arial, sans-serif; font-size:16px; line-height:19px; color:#30373b;  font-weight:bold;">Hari Ini : Selasa, 20 Desember 2017</td>
                  </tr>
                  <tr>
                    <td height="30" class="em_height">&nbsp;</td>
                  </tr>
                        ...
                        <tr>
                          ...
                          <td align="center" valign="top">
                            <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                <td align="center"  style="font-family:Open Sans, Arial, sans-serif; font-size:16px; line-height:19px; color:#ffffff;  font-weight:bold;">Bernand D H</td>
                              </tr>
                              <tr>
                                <td height="18" style="line-height:1px; font-size:1px;" class="em_height">&nbsp;</td>
                              </tr>
                              <tr>
                                <td  align="center"  style="font-family:Open Sans, Arial, sans-serif; font-size:16px; line-height:24px; color:#ffffff; font-style:italic;">&ldquo;Halo Bernand D H<br><br>Hari Ini Akan Didakan Latihan <br><br>Jangan Lupa Latihan Yah!&rdquo;
                                </td>
                              </tr>
                              <tr>
